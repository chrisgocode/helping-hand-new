/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 8b37e61bdc27538c3be53548002a29b5)
...
interface __BaseEnv_CloudflareBindings {
	...
	APP_ENV: "production";
	BETTER_AUTH_URL: "https://api.helpinghand.chrisgo.dev";
	TRUSTED_ORIGIN: "https://helpinghand.chrisgo.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "BETTER_AUTH_URL" | "TRUSTED_ORIGIN" | "OPENROUTER_MODEL" | "BETTER_AUTH_SECRET" | "OPENROUTER_API_KEY">> {}
}
